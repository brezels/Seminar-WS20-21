...
from keras.optimizers import Adam                   #基于tensorflow的深度学习框架
...
class DQ_Network:
    ...
    def __init__(self,
        ...
        self.lr = learning_rate #learn rate
        self.gamma = reward_decay #Reward decay value 
    ...
    def update_target_model(self):
        #Update the parameters in the target network 定义如何更新网络
...
#    """
    def learn(self):
        ...
        self.eval_model.fit(states, q_eval, verbose=0,epochs=1)
